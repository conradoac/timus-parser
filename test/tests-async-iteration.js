...
// testFail("for await (x of xs);", "Token não esperado (1:4)", { ecmaVersion: 9 })
// testFail("function f() { for await (x of xs); }", "Token não esperado (1:19)", { ecmaVersion: 9 })
// testFail("f = function() { for await (x of xs); }", "Token não esperado (1:21)", { ecmaVersion: 9 })
// testFail("f = () => { for await (x of xs); }", "Token não esperado (1:16)", { ecmaVersion: 9 })
// testFail("async function f() { () => { for await (x of xs); } }", "Token não esperado (1:33)", { ecmaVersion: 9 })
// testFail("async function f() { for await (x in xs); }", "Token não esperado (1:25)", { ecmaVersion: 9 })
// testFail("async function f() { for await (;;); }", "Token não esperado (1:25)", { ecmaVersion: 9 })
// testFail("async function f() { for await (x;;); }", "Token não esperado (1:25)", { ecmaVersion: 9 })
// testFail("async function f() { for await (let x = 0;;); }", "Token não esperado (1:25)", { ecmaVersion: 9 })
// testFail("async function f() { for await (x of xs); }", "Token não esperado (1:25)", { ecmaVersion: 8 })
...
// testFail("async function* f() { () => await a; }", "Token não esperado (1:34)", { ecmaVersion: 9 })
// testFail("async function* f() { () => yield a; }", "Token não esperado (1:34)", { ecmaVersion: 9 })

// testFail("async function* f() { await a; yield b; }", "Token não esperado (1:14)", { ecmaVersion: 8 })
...
// testFail("f = async function*() { () => await a; }", "Token não esperado (1:36)", { ecmaVersion: 9 })
// testFail("f = async function*() { () => yield a; }", "Token não esperado (1:36)", { ecmaVersion: 9 })
// testFail("obj = { async\n* f() {} }", "Token não esperado (2:0)", { ecmaVersion: 9 })
// testFail("obj = { *async f() {}", "Token não esperado (1:15)", { ecmaVersion: 9 })
// testFail("obj = { *async* f() {}", "Token não esperado (1:14)", { ecmaVersion: 9 })
// testFail("obj = { async* f() { () => await a; } }", "Token não esperado (1:33)", { ecmaVersion: 9 })
// testFail("obj = { async* f() { () => yield a; } }", "Token não esperado (1:33)", { ecmaVersion: 9 })
// testFail("class A { async\n* f() {} }", "Token não esperado (2:0)", { ecmaVersion: 9 })
// testFail("class A { *async f() {} }", "Token não esperado (1:17)", { ecmaVersion: 9 })
// testFail("class A { *async* f() {} }", "Token não esperado (1:16)", { ecmaVersion: 9 })
// testFail("class A { async* f() { () => await a; } }", "Token não esperado (1:35)", { ecmaVersion: 9 })
// testFail("class A { async* f() { () => yield a; } }", "The keyword 'yield' is reserved (1:29)", { ecmaVersion: 9 })

// testFail("f = async function*() { await a; yield b; }", "Token não esperado (1:18)", { ecmaVersion: 8 })
// testFail("obj = { async* f() { await a; yield b; } }", "Token não esperado (1:13)", { ecmaVersion: 8 })
// testFail("class A { async* f() { await a; yield b; } }", "Token não esperado (1:15)", { ecmaVersion: 8 })
...
// testFail("({ \\u0061sync *method(){} })", "Token não esperado (1:14)", { "ecmaVersion": 9 })
// testFail("void \\u0061sync function* f(){};", "Token não esperado (1:16)", { "ecmaVersion": 9 })
// testFail("for ( ; false; ) async function* g() {}", "Token não esperado (1:17)", { "ecmaVersion": 9 })
...
// testFail("({async\n    foo() { }})", "Token não esperado (2:4)", { "ecmaVersion": 9 })
