...
// testFail("async function* foo() { }", "Token não esperado (1:14)", {ecmaVersion: 8})
...
// testFail("(async\nfunction foo() { })", "Token não esperado (2:0)", {ecmaVersion: 8})

// // cannot combine with generators.
// testFail("(async function* foo() { })", "Token não esperado (1:15)", {ecmaVersion: 8})
...
// testFail("async\n() => a", "Token não esperado (2:3)", {ecmaVersion: 8})

// // cannot insert a linebreak before '=>'.
// testFail("async a\n=> a", "Token não esperado (2:0)", {ecmaVersion: 8})
// testFail("async ()\n=> a", "Token não esperado (2:0)", {ecmaVersion: 8})
...
// testFail("({async\nfoo() { }})", "Token não esperado (2:0)", {ecmaVersion: 8})

// // cannot combine with getters/setters/generators.
// testFail("({async get foo() { }})", "Token não esperado (1:12)", {ecmaVersion: 8})
// testFail("({async set foo(value) { }})", "Token não esperado (1:12)", {ecmaVersion: 8})
// testFail("({async* foo() { }})", "Token não esperado (1:7)", {ecmaVersion: 8})
...
// testFail("({async foo: 1})", "Token não esperado (1:11)", {ecmaVersion: 8})
...
// testFail("class A {async get foo() { }}", "Token não esperado (1:19)", {ecmaVersion: 8})
// testFail("class A {async set foo(value) { }}", "Token não esperado (1:19)", {ecmaVersion: 8})
// testFail("class A {async* foo() { }}", "Token não esperado (1:14)", {ecmaVersion: 8})
// testFail("class A {static async get foo() { }}", "Token não esperado (1:26)", {ecmaVersion: 8})
// testFail("class A {static async set foo(value) { }}", "Token não esperado (1:26)", {ecmaVersion: 8})
// testFail("class A {static async* foo() { }}", "Token não esperado (1:21)", {ecmaVersion: 8})
...
// testFail("await", "Não é permitido usar 'esperar' fora de uma função assíncrona (1:0)", {ecmaVersion: 8, sourceType: "module"})

// // Await expressions is invalid outside of async functions.
// testFail("await a", "Token não esperado (1:6)", {ecmaVersion: 8})
// testFail("await a", "Não é permitido usar 'esperar' fora de uma função assíncrona (1:0)", {ecmaVersion: 8, sourceType: "module"})
...
// testFail("async function foo() { await }", "Token não esperado (1:29)", {ecmaVersion: 8})
// testFail("(async function foo() { await })", "Token não esperado (1:30)", {ecmaVersion: 8})
// testFail("async () => await", "Token não esperado (1:17)", {ecmaVersion: 8})
// testFail("({async foo() { await }})", "Token não esperado (1:22)", {ecmaVersion: 8})
// testFail("(class {async foo() { await }})", "Token não esperado (1:28)", {ecmaVersion: 8})
...
// testFail("async (a = await b) => {}", "Token não esperado (1:17)", {ecmaVersion: 8})
...
// testFail("if (x) async function f() {}", "Token não esperado (1:7)", {ecmaVersion: 8})

// testFail("(async)(a) => 12", "Token não esperado (1:11)", {ecmaVersion: 8})

// testFail("f = async ((x)) => x", "Padrão entre parêntesis (1:11)", {ecmaVersion: 8})
...
// testFail("abc: async function a() {}", "Token não esperado (1:5)", {ecmaVersion: 8})
