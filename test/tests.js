...
const { TimusParser } = require('../dist/timus-parser')
const lume = require('./languages/lume.json')

const parser = new TimusParser('', { language: lume })

const _Object = parser.getLanguageSynonym('Object')

const _import = parser.getLanguageSynonym('import')
const _do = parser.getLanguageSynonym('do')
const _new = parser.getLanguageSynonym('new')
const _while = parser.getLanguageSynonym('while')
const _true = parser.getLanguageSynonym('true')
const _false = parser.getLanguageSynonym('false')
const _for = parser.getLanguageSynonym('for')
const _in = parser.getLanguageSynonym('in')
const _this = parser.getLanguageSynonym('this')
const _null = parser.getLanguageSynonym('null')
const _if = parser.getLanguageSynonym('if')
const _get = parser.getLanguageSynonym('get')
const _return = parser.getLanguageSynonym('return')
const _set = parser.getLanguageSynonym('set')
const _switch = parser.getLanguageSynonym('switch')
const _case = parser.getLanguageSynonym('case')
const _var = parser.getLanguageSynonym('var')
const _eval = parser.getLanguageSynonym('eval')
const _arguments = parser.getLanguageSynonym('arguments')
const _void = parser.getLanguageSynonym('void')
const _delete = parser.getLanguageSynonym('delete')
const _typeof = parser.getLanguageSynonym('typeof')
const _instanceof = parser.getLanguageSynonym('instanceof')
const _await = parser.getLanguageSynonym('await')
const _implements = parser.getLanguageSynonym('implements')
const _package = parser.getLanguageSynonym('package')
const _private = parser.getLanguageSynonym('private')
const _protected = parser.getLanguageSynonym('protected')
const _interface = parser.getLanguageSynonym('interface')
